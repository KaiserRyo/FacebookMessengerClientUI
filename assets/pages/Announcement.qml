...
Page 
{
    ...
    onCreationCompleted: 
    {
        var announcement_data     = JSON.parse(Qt.app.getStringFromFile("data/announcements.json"));
        ...
        ScrollView 
        {
            ...
            Container 
            {
                ...
                WebImageView 
                {
                    id: image
                    horizontalAlignment: HorizontalAlignment.Fill
                    minHeight: (Qt.app._is_passport ? 500 : 300)
                    maxWidth: Qt.app.getDisplayWidth()
