...
const QString _MY_MESSENGER_ID2     = "583669825050238";
const QString _GOCHAT_ID            = "138055292887831";

const QString FB_APP_ID             = _MY_MESSENGER_ID2;
...
void Utilities::notify_regular(QString title, QString message)
{
    ...
    qDebug() << "**** notify_regular() notificationsString: " + notificationsString + ", title: " + title + ", message: " + message;

    Notification* notification = new Notification();
    notification->setTitle(title);
    notification->setBody(message);
    notification->setIconUrl(QUrl("app/native/assets/media/images/icons/icon.png")) ;
...
qint64 Utilities::get_cache_size()
{
    ...
    QString images_low_quality  = QDir::homePath() + "/Cache/images_low_quality/";

    qint64 total_size = (get_folder_size(wallpapers) + get_folder_size(images) + get_folder_size(images_low_quality));
