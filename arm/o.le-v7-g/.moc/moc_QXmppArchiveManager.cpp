...
#include "../../../src/qxmpp/client/QXmppArchiveManager.h"
...
static const char qt_meta_stringdata_QXmppArchiveManager[] = {
    "QXmppArchiveManager\0\0,rsm\0"
    "archiveListReceived(QList<QXmppArchiveChat>,QXmppResultSetReply)\0"
    "archiveListReceived(QList<QXmppArchiveChat>)\0"
    "archiveChatReceived(QXmppArchiveChat,QXmppResultSetReply)\0"
    "archiveChatReceived(QXmppArchiveChat)\0"
};
...
const QMetaObjectExtraData QXmppArchiveManager::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QXmppArchiveManager::staticMetaObject = {
    { &QXmppClientExtension::staticMetaObject, qt_meta_stringdata_QXmppArchiveManager,
      qt_meta_data_QXmppArchiveManager, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QXmppArchiveManager::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QXmppArchiveManager))
