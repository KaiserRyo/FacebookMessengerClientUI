...
#include "../../../src/qxmpp/base/qdnslookup_p.h"
...
static const char qt_meta_stringdata_QDnsLookupRunnable[] = {
    "QDnsLookupRunnable\0\0reply\0"
    "finished(QDnsLookupReply)\0"
};
...
const QMetaObjectExtraData QDnsLookupRunnable::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QDnsLookupRunnable::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QDnsLookupRunnable,
      qt_meta_data_QDnsLookupRunnable, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QDnsLookupRunnable::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QDnsLookupRunnable))
...
static const char qt_meta_stringdata_QDnsLookupThreadPool[] = {
    "QDnsLookupThreadPool\0\0_q_applicationDestroyed()\0"
};
...
const QMetaObjectExtraData QDnsLookupThreadPool::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QDnsLookupThreadPool::staticMetaObject = {
    { &QThreadPool::staticMetaObject, qt_meta_stringdata_QDnsLookupThreadPool,
      qt_meta_data_QDnsLookupThreadPool, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QDnsLookupThreadPool::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QDnsLookupThreadPool))
