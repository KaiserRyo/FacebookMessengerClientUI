...
#include "../../../src/qxmpp/base/QXmppStream.h"
...
static const char qt_meta_stringdata_QXmppStream[] = {
    ...
    "sendCloseStream\0disconnectFromHost(bool)\0"
...
void QXmppStream::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->disconnectFromHost((*reinterpret_cast< const bool(*)>(_a[1]))); break;
        case 3: _t->disconnectFromHost(); break;
        case 4: { bool _r = _t->sendData((*reinterpret_cast< const QByteArray(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 5: _t->_q_socketConnected(); break;
        case 6: _t->_q_socketEncrypted(); break;
        case 7: _t->_q_socketError((*reinterpret_cast< QAbstractSocket::SocketError(*)>(_a[1]))); break;
        case 8: _t->_q_socketReadyRead(); break;
        default: ;
        }
    }
}
