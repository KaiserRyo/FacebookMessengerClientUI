...
#include "../../../src/qxmpp/client/QXmppMessageReceiptManager.h"
...
static const char qt_meta_stringdata_QXmppMessageReceiptManager[] = {
    "QXmppMessageReceiptManager\0\0jid,id\0"
    "messageDelivered(QString,QString)\0"
};
...
const QMetaObjectExtraData QXmppMessageReceiptManager::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QXmppMessageReceiptManager::staticMetaObject = {
    { &QXmppClientExtension::staticMetaObject, qt_meta_stringdata_QXmppMessageReceiptManager,
      qt_meta_data_QXmppMessageReceiptManager, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QXmppMessageReceiptManager::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QXmppMessageReceiptManager))
